...
if("TRUE" STREQUAL "TRUE")
  set(navfn_SOURCE_PREFIX /home/morin-sol/ME652/src/navigation/navfn)
  set(navfn_DEVEL_PREFIX /home/morin-sol/ME652/devel)
  set(navfn_INSTALL_PREFIX "")
  set(navfn_PREFIX ${navfn_DEVEL_PREFIX})
else()
  set(navfn_SOURCE_PREFIX "")
  set(navfn_DEVEL_PREFIX "")
  set(navfn_INSTALL_PREFIX /home/morin-sol/ME652/install)
...
if(NOT "/home/morin-sol/ME652/devel/include;/home/morin-sol/ME652/src/navigation/navfn/include " STREQUAL " ")
  set(navfn_INCLUDE_DIRS "")
  set(_include_dirs "/home/morin-sol/ME652/devel/include;/home/morin-sol/ME652/src/navigation/navfn/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'navfn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/morin-sol/ME652/src/navigation/navfn/${idir}'.  ${_report}")
    endif()
