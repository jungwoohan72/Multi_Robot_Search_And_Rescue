...
bool operator==(const ::move_base_msgs::MoveBaseActionFeedback_<ContainerAllocator1> & lhs, const ::move_base_msgs::MoveBaseActionFeedback_<ContainerAllocator2> & rhs)
{
