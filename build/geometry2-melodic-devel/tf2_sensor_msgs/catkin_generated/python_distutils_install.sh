...
echo_and_run cd "/home/morin-sol/ME652/src/geometry2-melodic-devel/tf2_sensor_msgs"
...
echo_and_run /usr/bin/env \
    ...
    "/home/morin-sol/ME652/src/geometry2-melodic-devel/tf2_sensor_msgs/setup.py" \
     \
    build --build-base "/home/morin-sol/ME652/build/geometry2-melodic-devel/tf2_sensor_msgs" \
    install \
    --root="${DESTDIR-/}" \
