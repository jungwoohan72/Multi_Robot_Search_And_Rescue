...
echo_and_run cd "/home/morin-sol/ME652/src/turtlebot3_teleop"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/morin-sol/ME652/src/turtlebot3_teleop/setup.py" \
     \
    build --build-base "/home/morin-sol/ME652/build/turtlebot3_teleop" \
    install \
    --root="${DESTDIR-/}" \
