...
class InitialPoseGenerator:
    ...
    def initial_pose_publish(self):
        ...
        robot1_initial.header.frame_id = "robot1/map"
        ...
        robot1_initial.pose.pose.orientation.z = 1.57

        robot2_initial.header.frame_id = "robot2/map"
        ...
        robot2_initial.pose.pose.orientation.z = -1.57

        robot3_initial.header.frame_id = "robot3/map"
        ...
        robot3_initial.pose.pose.orientation.z = 1.57
